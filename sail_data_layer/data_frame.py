...
class DataFrame(DataFramePandas):
    ...
    def __init__(
        self, dataset_id: str, data_frame_name: str, list_series: List[Series]
    ) -> None:
        super().__init__()
    ...
    def get_series(self, series_name: str) -> Series:
        print(f"get_series: {series_name}")
        print(f"self.list_series_name: {self.list_series_name}")
    ...
    def from_csv_str(
        ...
        return DataFrame.from_pandas(
            dataset_id, data_frame_name, data_frame_data_model, data_frame_pandas
        )
    ...
    def from_pandas(
        ...
        for series_name in data_frame_data_model.list_series_name:
            series = Series.from_pandas(
                dataset_id,
                data_frame_data_model[series_name],
                data_frame_pandas[series_name],
            )
